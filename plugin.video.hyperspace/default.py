...
ADDON_PATH = xbmc.translatePath('special://home/addons/plugin.video.hyperspace')
ICON = ADDON_PATH + 'icon.png'
FANART = ADDON_PATH + 'fanart.jpg'
PATH = 'Hyperspace'
VERSION = '0.0.1'
Dialog = xbmcgui.Dialog()
Base_Url = 'http://thereaper.x10host.com/hyperspace/'

def Main_Menu():
    OPEN = Open_Url('http://thereaper.x10host.com/hyperspace/mainmenu.php')
    ...
    for name,url,icon,fanart,desc in Regex:
        if '.php' in url:
            ...
            Menu(name,url,3,icon,fanart,desc)
        else:
            Play(name,url,2,icon,fanart,desc)

    setView('tvshows', 'Media Info')
...
def Search():
    ...
    filename = ['serialsearch','demosearch2','demosearch3','demosearch4','demosearch5']
